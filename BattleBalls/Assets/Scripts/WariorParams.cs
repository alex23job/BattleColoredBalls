...
namespace Assets.Scripts
{
    public class WariorParams
    {
        ...
        public static WariorParams[] arrWariorParams = {
            new WariorParams("Враг1", "Warior1", 20, 0, 1, 1, 1, 1, 1, 1, 1),
            new WariorParams("Враг2", "Warior2", 40, 3, 50, 30, 2, 2, 2, 2, 2),
            new WariorParams("Враг3", "Warior3", 60, 1, 80, 60, 3, 3, 3, 3, 3)
        };
    }
}
